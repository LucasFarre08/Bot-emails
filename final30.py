...
for id_cliente, razao_social in clientes:
    ...
    cursor.execute("""
            ...
            AND v.inicio < %s
            GROUP BY v.grouping
            HAVING litros > 0 AND km > 100
            ORDER BY (km/litros) DESC
            LIMIT 10
        """,(id_cliente,inicio_ultimo_mes,fim_ultimo_mes))
    ...
    if placas_p:
        ...
        plt.yticks(y, placas_p)  # 🔥 corrigido (antes tava placas_m)
